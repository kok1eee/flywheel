...
- **判断の枝が残る限り止まらない**。モデルは「もう十分 / 共有理解に達した」を *自己宣言しない* ——**止めるのは人間**（「もういい / 握れた / 進めて」）。止める直前に「**未決の判断** の枝はこれ」を提示してから人間に stop/continue を聞く（informed stop）。※「無限に聞く」ではない: 止まらないのは *判断* の枝が残る間だけで、上の `事実=self-answer` filter は維持する（低価値質問は量産しない）
...
詰めた決定を構造化して確認する。**止める前に必ず**、まだ決めていない **未決の判断** の枝を列挙して提示し、「ここで握って進める? それとも続けて詰める?」を人間に聞く——**止めるのは人間**で、モデルから「もう十分」と切り上げない。残った**未解決点・リスク**も併記する。
